	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Increment':
				return _Utils_Tuple2(
					model,
					$author$project$Main$increment(model.count));
			case 'Decrement':
				return _Utils_Tuple2(
					model,
					$author$project$Main$decrement(model.count));
			case 'Reset':
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									buttonStyle,
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Minimize)
								]),
							_List_fromArray(
								[
